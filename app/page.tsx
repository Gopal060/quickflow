        ...
        <div className="md:px-48">
          {/* <div>
            ...
            <p className="leading-8 text-lg [&:not(:first-child)]:mt-6 text-slate-500 font-normal">
              Quick flow is new application to create quickly forms and
              collect enough data for your surveys or your needs.
            </p>
          </div> */}
          <div className="mt-12">
            <h3 className="scroll-m-20 border-b pb-2 text-3xl font-bold tracking-tight transition-colors first:mt-0">
              QuickFlow with simple features
            </h3>
            <p className="leading-8 text-lg [&:not(:first-child)]:mt-6 text-slate-500 font-normal">
              1. Quick form creation in very less time.
            </p>
            <p className="leading-8 text-lg [&:not(:first-child)]:mt-6 text-slate-500 font-normal">
              2. Easy publication of forms and viewing of response with charts.
            </p>
            <p className="leading-8 text-lg [&:not(:first-child)]:mt-6 text-slate-500 font-normal">
